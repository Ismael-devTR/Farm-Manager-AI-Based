  ...
  return (
    <form action={formAction} className="grid grid-cols-2 gap-3">
      <div>
        ...
        <input name="recordDate" type="date" required defaultValue={today} className={cls} />
      </div>
      <div>
        <label className="block text-xs font-medium text-gray-600 mb-1">{t.week} *</label>
        <input name="weekNumber" type="number" required min="1" placeholder={t.weekPlaceholder} className={cls} />
      </div>
      <div>
        <label className="block text-xs font-medium text-gray-600 mb-1">{t.totalWeight} *</label>
        <input name="totalWeight" type="number" required step="0.1" min="0" placeholder={t.totalWeightPlaceholder} className={cls} />
      </div>
      <div>
        <label className="block text-xs font-medium text-gray-600 mb-1">{t.animalsWeighed} *</label>
        <input name="animalCount" type="number" required min="1" placeholder={t.animalsPlaceholder} className={cls} />
      </div>
