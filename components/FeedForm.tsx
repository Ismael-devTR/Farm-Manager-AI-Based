  ...
  return (
    <form action={formAction} className="grid grid-cols-2 gap-3">
      ...
      <div>
        ...
        <input name="feedType" type="text" required placeholder={t.feedTypePlaceholder} className={cls} />
      </div>
      <div>
        <label className="block text-xs font-medium text-gray-600 mb-1">{t.quantity} *</label>
        <input name="quantityKg" type="number" required step="0.1" min="0" placeholder={t.quantityPlaceholder} className={cls} />
      </div>
      <div>
        <label className="block text-xs font-medium text-gray-600 mb-1">{t.costPerKg} *</label>
        <input name="costPerKg" type="number" required step="0.01" min="0" placeholder={t.costPerKgPlaceholder} className={cls} />
      </div>
